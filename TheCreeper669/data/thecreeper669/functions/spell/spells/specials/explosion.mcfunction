# particles : high
particle minecraft:explosion_emitter ~ ~ ~ 0 0 0 1 7 force
particle minecraft:flame ~ ~ ~ 0 0 0 1 511 force
particle minecraft:large_smoke ~ ~ ~ 0 0 0 1 511 force

# particles : low
#particle minecraft:explosion_emitter ~ ~ ~ 0 0 0 1 1 force

# sound
playsound minecraft:entity.generic.explode player @a ~ ~ ~ 255 0.8
